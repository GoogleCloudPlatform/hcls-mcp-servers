...
"""
This script acts as a bridge for Antigravity to connect to remote IAM-secured Cloud Run MCP servers over SSE. It wraps stdio to allow Antigravity to use remote SSE servers.
It will be removed once Antigravity natively supports remote OIDC endpoints.
"""
...
CACHE_FILE = os.path.expanduser("~/.gemini/antigravity/.oidc_token_cache")
